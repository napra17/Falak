				...
				<form name="edit_product" id="edit_product">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="number" name="edit_tel2" id="edit_tel2" class="form-control">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="edit_local" id="edit_local" class="form-control">
						</div>
						<div class="form-group">
							<label>Categoria</label>
							<input type="text" name="edit_cate" id="edit_cate" class="form-control">
						</div>
						<div class="form-group">
							<label>Datos Medicos</label>
							<textarea type="text" name="edit_observ" id="edit_observ" class="form-control">
						</textarea>
						</div>					
					</div>
